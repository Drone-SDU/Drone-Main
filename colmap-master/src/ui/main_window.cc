...
void MainWindow::CreateWidgets() {
  ...
  render_options_widget_ = new RenderOptionsWidget(this, &options_, opengl_window_);
...
void MainWindow::CreateActions() {
  ...
  connect(action_export_as_text_, &QAction::triggered, this, &MainWindow::ExportAsText);
  ...
  action_automatic_reconstruction_ =
      new QAction(QIcon(":/media/start-3D-reconstruction.png"),
  ...
  custom_action_1_ = new QAction(QIcon(":/media/one.png"),tr("Action One"),this);
...
//  extras_toolbar_->setIconSize(QSize(16, 16));
  ...
  custom_sdu_toolbar_->setIconSize(QSize(320,32));
}
